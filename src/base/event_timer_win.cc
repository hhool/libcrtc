...
webrtc::EventTypeWrapper EventTimerWin::Wait(unsigned long max_time) {
  unsigned long res = WaitForSingleObject(event_, max_time);
  switch (res) {
    case WAIT_OBJECT_0:
      return webrtc::EventTypeWrapper::kEventSignaled;
    case WAIT_TIMEOUT:
      return webrtc::EventTypeWrapper::kEventTimeout;
    default:
      return webrtc::EventTypeWrapper::kEventTimeout;
  }
}
